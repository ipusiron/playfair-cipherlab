...
日本語・英語の画面、9ミッションの学習ロードマップ、操作場所を示すナビ、ヒント付きの解読チャレンジを備えています。
...
- 9ミッション（鍵表1・暗号化3・復号2・チャレンジ3）の達成・次・未・ロックと、おすすめの次の操作
...
M1〜M6は順番を強制しません。「次はこれ」は未達成でロックされていない最初のミッションです。
すべて達成すると9/9・60/60ptになり、同じ文を変種で暗号化して比べる案内を表示します。
...
C1は最初から挑戦できます。C2はC1、C3はC2に正解すると開きます。M1〜M6の達成は解放条件ではありません。
...
日英READMEの9ミッション、既知解答5行、チャレンジ3行とヒントも、ProgressCore・PlayfairCore・課題データ・辞書から検証します。
...
├── index.html                     # 画面（3タブ・処理過程・ナビ・ヘルプ・meta CSP）
├── assets/                        # README用の画像
│   ├── en/                        # 英語版READMEの画像
