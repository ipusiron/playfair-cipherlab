...
日本語・英語の画面、暗号文の解析、鍵表の復元3問、14ミッションの学習ロードマップ、操作場所を示すナビ、ヒント付きの解読チャレンジを備えています。
...
- チャレンジ3問と復元3問の得点管理（それぞれ10・20・30点、合計120点、各問1回だけ加算）
- 14ミッション（鍵表1・暗号化3・復号2・解析2・チャレンジ3・復元3）の達成・次・未・ロックと、おすすめの次の操作
- 操作で手順を自動判定するナビと、ヒントなしの初回正解を示す★
- C1→C2→C3、R1→R2→R3それぞれのロック解除と、確認ダイアログ付きの進捗リセット
...
ナビも解読・復元のヒントも減点しません。ヒントを見ずに初回正解した課題には★が付きます。
